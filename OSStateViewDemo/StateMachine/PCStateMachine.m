...
@property(nonatomic, strong) PCState *previousState;
...
- (BOOL)enterState:(Class)stateClass {
    ...
    [self.previousState willExitWithNextState:nextState];
    self.currentState = nextState;
    [self.currentState didEnterWithPreviousState:self.previousState];
